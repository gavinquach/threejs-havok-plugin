...
export class Physics6DoFConstraint extends PhysicsConstraint {
    ...
    constructor(
        ...
        super(PhysicsConstraintType.SIX_DOF, constraintParams, havokPlugin);
        this.limits = limits;
    }
     ...
     *
     */
    public getAxisFriction(axis: PhysicsConstraintAxis): number | null {
    ...
    public getAxisMode(
        axis: PhysicsConstraintAxis
    ): PhysicsConstraintAxisLimitMode | null {
     ...
     *
     */
    public getAxisMinLimit(axis: PhysicsConstraintAxis): number | null {
     ...
     *
     */
    public getAxisMaxLimit(axis: PhysicsConstraintAxis): number | null {
    ...
    public getAxisMotorType(
        axis: PhysicsConstraintAxis
    ): PhysicsConstraintMotorType | null {
     ...
     *
     */
    public getAxisMotorTarget(axis: PhysicsConstraintAxis): number | null {
     ...
     *
     */
    public getAxisMotorMaxForce(axis: PhysicsConstraintAxis): number | null {
...
export class BallAndSocketConstraint extends PhysicsConstraint {
    constructor(
        ...
        super(
            ...
            { pivotA: pivotA, pivotB: pivotB, axisA: axisA, axisB: axisB },
            havokPlugin
        );
    }
}
...
export class DistanceConstraint extends PhysicsConstraint {
    constructor(maxDistance: number, havokPlugin: HavokPlugin) {
        super(
...
export class PrismaticConstraint extends PhysicsConstraint {
    constructor(
        ...
        super(
            PhysicsConstraintType.PRISMATIC,
            { pivotA: pivotA, pivotB: pivotB, axisA: axisA, axisB: axisB },
            havokPlugin
        );
    }
