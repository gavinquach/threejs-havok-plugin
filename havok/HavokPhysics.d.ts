...
export interface HavokPhysicsWithBindings extends globalThis.EmscriptenModule {
...
declare const HK : globalThis.EmscriptenModuleFactory<HavokPhysicsWithBindings>;
export default HK
